---
title: "SEO settings"
summary: "Manage your website's SEO settings."
...
The website automatically generates meta- and open graph tags for your pages based on the `content.tsx` file.

## Schema

The website automatically generates schema tags for your pages based on the `content.tsx` file.
