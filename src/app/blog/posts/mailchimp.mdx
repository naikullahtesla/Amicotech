...
summary: "Set up the Mailchimp newsletter block for your website."
...
Create a new [embed form](https://mailchimp.com/help/add-a-signup-form-to-your-website/) and copy the form URL to your website config.
...
You can modify the headline and description in the `content.tsx` file.
